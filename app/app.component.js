            ...
            AppComponent = (function () {
                function AppComponent() {
                    this.meals = [
                        ...
                        new meal_model_1.Meal("Loaded Bacon Ranch Chili Cheese Coney", "The ultimate combination of crispy bacon, chili and melty cheese. The Loaded Bacon Ranch Chili Cheese Coney is made with 100 percent beef and topped with chili, shredded cheese, crisp bacon and zesty ranch.", 510, 1600, 5),
                        new meal_model_1.Meal("SONIC Blast made with M&M’S Chocolate Candies", "Sweet, cold, real vanilla ice cream blended with colorful M&M’S Chocolate Candies.", 520, 200, 58)
                    ];
                }
