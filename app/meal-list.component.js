    ...
    return {
        ...
        execute: function() {
            MealListComponent = (function () {
                ...
                MealListComponent.prototype.createMeal = function (name, description, calories, sodium, sugar) {
                    this.mealList.push(new meal_model_1.Meal(name, description, calories, sodium, sugar, this.mealList.length));
                };
